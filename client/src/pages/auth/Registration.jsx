    ...
    <div>
      <div className="md:w-1/3 w-full md:px-2 px-4 mx-auto mt-20 p-3 shadow-lg">
        ...
        <div className="mt-4 relative rounded-lg text-gray-400">
          <label htmlFor="" className="ml-2">Sign up as</label>
          <div className="flex p-2 gap-2">
          <div onClick={()=> setUserType('vendor')} className={`flex-1 gap-2 flex justify-center border px-2 py-1 rounded-lg cursor-pointer ${userType == 'vendor' && 'bg-blue-900 text-white'}`}>
          <label htmlFor="">Vendor</label>
            ...
            <div onClick={()=> setUserType('client')} className={`flex-1 gap-2 flex justify-center border px-2 py-1 rounded-lg cursor-pointer ${userType == 'client' && 'bg-blue-900 text-white'}`}>
        ...
        <div className="mt-4 relative rounded-lg">
          <select onChange={handleSelectedCategory} value={selectedCategory} className="w-full border py-2 px-3 rounded-lg" id="">
