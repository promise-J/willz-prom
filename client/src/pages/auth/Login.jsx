    ...
    <div>
      <div className="w-2/3 mx-auto mt-20 p-3 shadow-lg">
        ...
        <div className="mt-4 py-4 flex flex-col items-center">
            <h2>Dont have an account yet? <Link className="text-blue-900" to='/sign-up'>Sign up</Link></h2>
        </div>
        <div className="mt-4 py-4 flex flex-col items-center">
            <h1 className="text-blue-900 flex gap-3 cursor-pointer">Sign in with <img className="w-[30px] h-[30px]" src="/images/google-image.png" /></h1>
        </div>
      </div>
    </div>
  );        
